...
if($_SESSION['Armor']<6 AND $_SESSION['observe'] == 0)
{
    if(isset($_SESSION['gold']) AND $_SESSION['gold'] >= 50+50*$_SESSION['Armor'])
{
//on enlève Xor (prix du magasin)
$_SESSION['gold'] = $_SESSION['gold']-(50+50*$_SESSION['Armor']);
...
$_SESSION['Armor'] = $_SESSION['Armor'] + 1;
$insertWeapon = $bdd->prepare("UPDATE armory SET Armor = ? WHERE ID = ?");
$insertWeapon->execute(array($_SESSION['Armor'],$_SESSION['ShopID']));

...
if($_SESSION['pv']==0 AND $_SESSION['observe'] == 0)
{
    if(isset($_SESSION['gold']) AND $_SESSION['gold'] >= 25 )
{
...
//on donne la potion
$_SESSION['pv'] = 1;
$insertWeapon = $bdd->prepare("UPDATE potion SET pv = ? WHERE DID = ?");
$insertWeapon->execute(array($_SESSION['pv'],$_SESSION['ShopPotionID']));
//énergie
